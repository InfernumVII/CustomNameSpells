...
namespace CustomNameSpells.Config
{
    public static class VoiceCommandConfig
    {
        ...
        public static void Init(ConfigFile config)
        {
            ...
            BubbleCommand = config.Bind("AdditionalCommands", "Bubble", "bubble",
                "Command for Bubble spell (all variants of the word can be separated by a space)");
            
            DoomCommand = config.Bind("AdditionalCommands", "Doom", "doom",
                "Command for Doom spell (all variants of the word can be separated by a space)");
        }
    }
}